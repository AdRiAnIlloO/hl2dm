...
{
	// Safety check against NaN's or really huge numbers, and normalize as necessary
	if ( !IsEntityQAngleReasonable( angles ) )
	{
		...
		const_cast<QAngle&>(angles).Init(AngleNormalize(angles.x), AngleNormalize(angles.y), AngleNormalize(angles.z));
	}
